...
ID de versión
 a| 
El código de versión de la versión específica de un objeto cuyos metadatos se han actualizado. Las operaciones en cubos y objetos en depósitos sin versiones no incluyen este campo.
