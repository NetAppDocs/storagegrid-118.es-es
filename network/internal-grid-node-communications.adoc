...
Si las políticas de redes empresariales restringen el acceso a cualquiera de estos puertos, puede reasignar los puertos al implementar nodos mediante VMware vSphere Web Client o mediante un valor de archivo de configuración al automatizar la puesta en marcha de nodos de grid. Para obtener más información acerca de la reasignación de puertos y los parámetros de configuración de implementación, consulte
...
Todos los nodos
 a| 
Proporciona el servicio DNS multicast (mDNS) utilizado para cambios de IP en toda la red y para el descubrimiento del nodo de administración principal durante la instalación, expansión y recuperación.
