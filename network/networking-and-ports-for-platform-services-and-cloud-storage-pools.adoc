...
Como se describe en link:../admin/manage-platform-services-for-tenants.html["Gestione servicios de plataforma para clientes"] y.. link:../tenant/what-platform-services-are.html["Gestione los servicios de la plataforma"], Los servicios de plataforma incluyen servicios externos que proporcionan integración de búsqueda, notificación de eventos y replicación CloudMirror.
