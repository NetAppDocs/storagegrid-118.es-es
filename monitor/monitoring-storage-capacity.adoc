...
Supervise las previsiones de uso de espacio para los datos de usuario y los metadatos para estimar cuándo lo necesitará link:../expand/index.html["expanda una cuadrícula"].
