...
Para obtener información sobre cómo acceder a los archivos de registro, consulte link:../monitor/collecting-log-files-and-system-data.html["Recopilar archivos de registro y datos del sistema"].
