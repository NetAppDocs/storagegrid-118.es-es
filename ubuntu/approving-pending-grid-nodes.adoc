...
+
Para obtener más información, consulte https://docs.netapp.com/us-en/storagegrid-appliances/installconfig/index.html["Inicio rápido para la instalación de hardware"^] para localizar las instrucciones del aparato.
...
.. Confirme que puede configurar las redes adecuadas. Ya deben rellenarse con la información proporcionada en la página de configuración de IP del instalador de dispositivos.
+
Para saber cómo instalar dispositivos StorageGRID, consulte https://docs.netapp.com/us-en/storagegrid-appliances/installconfig/index.html["Inicio rápido para la instalación de hardware"^] para localizar las instrucciones del aparato.
