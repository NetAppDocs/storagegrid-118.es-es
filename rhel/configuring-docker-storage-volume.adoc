...
El sistema StorageGRID se ejecuta en Red Hat Enterprise Linux como una colección de contenedores. Si ha elegido utilizar el motor de contenedor Docker, siga estos pasos para instalar Docker. En caso contrario, <<Instalar Podman,Instalar Podman>>.
