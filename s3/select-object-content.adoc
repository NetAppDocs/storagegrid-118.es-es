...
Para obtener más información, consulte https://docs.aws.amazon.com/AmazonS3/latest/API/API_SelectObjectContent.html["Referencia de API de Amazon Simple Storage Service: SelectObjectContent"^].
