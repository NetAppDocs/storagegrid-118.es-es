...
Consulte https://docs.netapp.com/us-en/storagegrid-appliances/installconfig/optional-enabling-node-encryption.html["Habilite el cifrado del nodo"^] para obtener más detalles.
