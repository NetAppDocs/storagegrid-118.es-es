...
* Tienes el https://docs.pingidentity.com/pingfederate/latest/administrators_reference_guide/pf_administrators_reference_guide.html["Guía de referencia del administrador"^] para PingFederate Server. La documentación de PingFederate ofrece instrucciones detalladas paso a paso y explicaciones.
