...
+
Si un usuario pertenece a varios grupos, los permisos son acumulativos. Consulte
link:managing-admin-groups.html["Gestione los grupos de administradores"] para obtener más detalles.
