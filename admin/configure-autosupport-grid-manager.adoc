...
* https://docs.netapp.com/us-en/storagegrid-appliances/installconfig/configuring-snmp-settings-for-bmc.html["Configurar los ajustes de SNMP para BMC"^] Para la controladora SG6000-CN o los dispositivos de servicios SG100 y SG1000
