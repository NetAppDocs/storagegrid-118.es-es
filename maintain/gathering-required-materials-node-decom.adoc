...
Paquete de recuperación `.zip` archivo
 a| 
Debe link:downloading-recovery-package.html["Descargue el paquete de recuperación más reciente"] `.zip` archivo (`sgws-recovery-package-_id-revision_.zip`). Puede utilizar el archivo de paquete de recuperación para restaurar el sistema si se produce un fallo.
