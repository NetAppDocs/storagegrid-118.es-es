...
summary: Cuando se activa la alerta de Objetos perdidos, debes investigar de inmediato. Recopile información sobre los objetos afectados y comuníquese con el soporte técnico. 
---
