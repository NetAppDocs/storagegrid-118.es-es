...
+
Si selecciona *Sí*, la opción “Hora no corriente” se seleccionará automáticamente para la Hora de referencia en link:create-ilm-rule-define-placements.html["Paso 2 del asistente Crear una regla de ILM"].
